...
enum AppConfig {
    ...
    /// 無料版で登録できる記録の上限（4モジュール合計）
    static let freeTotalLimit = 15
    ...
    static let premiumProductID = "com.kuromakuaikin.odekakememories.premium"
    static let adFreeProductID = "com.kuromakuaikin.odekakememories.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/odekake-memories/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/odekake-memories/terms.html")!
}

// MARK: - テーマカラー（#E0673C 系のコーラルオレンジ）

extension Color {
    static let odekakeTint = Color(red: 224.0 / 255.0, green: 103.0 / 255.0, blue: 60.0 / 255.0)
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("odekakememories:" + code).utf8))
