...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.datememo.premium"
    static let adFreeProductID = "com.kuromakuaikin.datememo.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/date-memo/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/date-memo/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("datememo:" + code).utf8))
