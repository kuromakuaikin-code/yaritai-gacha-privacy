...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.omamorireminder.premium"
    static let adFreeProductID = "com.kuromakuaikin.omamorireminder.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/omamori-reminder/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/omamori-reminder/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("omamorireminder:" + code).utf8))
