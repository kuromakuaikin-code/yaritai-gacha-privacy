...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.shugimemo.premium"
    static let adFreeProductID = "com.kuromakuaikin.shugimemo.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/shugi-memo/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/shugi-memo/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("shugimemo:" + code).utf8))
