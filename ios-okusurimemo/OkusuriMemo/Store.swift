...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.okusurimemo.premium"
    static let adFreeProductID = "com.kuromakuaikin.okusurimemo.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/okusuri-memo/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/okusuri-memo/terms.html")!
}

// MARK: - アプリ全体のアクセントカラー（医療系のティール）

extension Color {
    static let appTint = Color(red: 0x2A / 255.0, green: 0x7F / 255.0, blue: 0x9E / 255.0)
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("okusurimemo:" + code).utf8))
