...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.kodomogrowth.premium"
    static let adFreeProductID = "com.kuromakuaikin.kodomogrowth.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/kodomo-growth/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/kodomo-growth/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("kodomogrowth:" + code).utf8))
