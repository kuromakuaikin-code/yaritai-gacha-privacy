...
enum AppConfig {
    ...
    /// 無料版で登録できる宛先の上限
    static let freeContactLimit = 30
    ...
    static let premiumProductID = "com.kuromakuaikin.nengamemo.premium"
    static let adFreeProductID = "com.kuromakuaikin.nengamemo.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/nenga-memo/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/nenga-memo/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("nengamemo:" + code).utf8))
