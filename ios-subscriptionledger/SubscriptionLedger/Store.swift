...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.subscriptionledger.premium"
    static let adFreeProductID = "com.kuromakuaikin.subscriptionledger.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/subscription-ledger/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/subscription-ledger/terms.html")!
}

// MARK: - ブランドカラー（#7B3FA0 系）

extension Color {
    static let brand = Color(red: 123.0 / 255.0, green: 63.0 / 255.0, blue: 160.0 / 255.0)
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("subscriptionledger:" + code).utf8))
