...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.shelflifememo.premium"
    static let adFreeProductID = "com.kuromakuaikin.shelflifememo.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/shelf-life-memo/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/shelf-life-memo/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("shelflifememo:" + code).utf8))
