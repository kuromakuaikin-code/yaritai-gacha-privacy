...
enum AppConfig {
    ...
    static let premiumProductID = "com.kuromakuaikin.gomicalendar.premium"
    static let adFreeProductID = "com.kuromakuaikin.gomicalendar.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/gomi-calendar/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/gomi-calendar/terms.html")!
}
...
final class PurchaseStore: ObservableObject {
    ...
    /// プレミアム限定機能（ルール無制限・通知リマインダー）が使えるか
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("gomicalendar:" + code).utf8))
