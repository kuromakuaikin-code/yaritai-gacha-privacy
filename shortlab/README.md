...
実装済み: 動画取り込み / カット・結合 / トリム / 分割 / 速度変更 / テキストオーバーレイ(焼き込み・5色) / BGM(音量ミックス済み) / 1080p書き出し(透かし対応・書き出し中スリープ防止) / undo / できた動画のプレビュー / **プロジェクト自動保存・復元** / **買い切り課金(StoreKit 2・透かし解除+広告非表示)** / **AdMob バナー掲載口(保存完了画面のみ)** / アプリアイコン / プライバシーポリシー・利用規約ページ
