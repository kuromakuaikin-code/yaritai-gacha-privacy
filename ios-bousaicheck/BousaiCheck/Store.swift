...
enum AppConfig {
    ...
    /// 無料版で追加できるカスタム項目（isPreset == false）の上限。標準項目（プリセット）は無制限に利用可能
    static let freeCustomItemLimit = 5
    ...
    static let premiumProductID = "com.kuromakuaikin.bousaicheck.premium"
    static let adFreeProductID = "com.kuromakuaikin.bousaicheck.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/bousai-check/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/bousai-check/terms.html")!
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("bousaicheck:" + code).utf8))
