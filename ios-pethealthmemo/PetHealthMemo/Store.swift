...
enum AppConfig {
    ...
    /// 無料版で登録できる記録の上限（全ペット合計）
    static let freeRecordLimit = 30
    ...
    static let premiumProductID = "com.kuromakuaikin.pethealthmemo.premium"
    static let adFreeProductID = "com.kuromakuaikin.pethealthmemo.adfree"

    static let privacyURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/pet-health-memo/privacy.html")!
    static let termsURL = URL(string: "https://kuromakuaikin-code.github.io/yaritai-gacha-privacy/pet-health-memo/terms.html")!

    /// アプリのテーマカラー（暖色系オレンジ #E08A3C）
    static let tintColor = Color(red: 0.878, green: 0.541, blue: 0.235)
}
...
enum Passcode {
    static func hash(_ code: String) -> String {
        let digest = SHA256.hash(data: Data(("pethealthmemo:" + code).utf8))
