...
struct RootTabView: View {
    ...
    var body: some View {
        TabView {
            ...
            UpcomingView()
                .tabItem { Label("次回予定", systemImage: "calendar.badge.clock") }
            SettingsView()
                .tabItem { Label("設定", systemImage: "gearshape.fill") }
        }
        .tint(AppConfig.tintColor)
                ...
                HStack(spacing: 16) {
                    ForEach(0..<4, id: \.self) { i in
                        Circle()
                            ...
                            .background(Circle().fill(i < input.count ? AppConfig.tintColor : Color.clear))
